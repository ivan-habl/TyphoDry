...
static void event_handler_cb_charts_obj4(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff2e6f7c), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
...
void tick_screen_main() {
    ...
    }
    {
        ...
        int32_t cur_val = lv_led_get_brightness(objects.obj3);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj3;
            lv_led_set_brightness(objects.obj3, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
...
void create_screen_charts() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffd6aee6), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_charts_obj4, LV_EVENT_ALL, flowState);
...
static const char *object_names[] = { "main", "charts", "obj0", "obj1", "obj2", "temperature_setpoint", "obj3", "stop", "start", "arc_timer", "keyboard", "obj4", "obj5", "obj6", "obj7", "obj8", "temperature", "obj9", "obj10", "humidity", "obj11", "obj12", "obj13", "obj14", "obj15", "obj16", "obj17", "obj18", "cont_1", "chart_1", "obj19" };
